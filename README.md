...
[![Build Status](https://travis-ci.org/nasbeer/alpha_vantage.png?branch=master)](https://travis-ci.org/RomelTorres/alpha_vantage)
...
[![Average time to resolve an issue](http://isitmaintained.com/badge/resolution/nasbeer/alpha_vantage.svg)](http://isitmaintained.com/project/nasbeer/alpha_vantage "Average time to resolve an issue")
[![Percentage of issues still open](http://isitmaintained.com/badge/open/nasbeer/alpha_vantage.svg)](http://isitmaintained.com/project/nasbeer/alpha_vantage "Percentage of issues still open")
